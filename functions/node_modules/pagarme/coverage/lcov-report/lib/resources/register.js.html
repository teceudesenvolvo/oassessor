...
<html lang="en">
<head>
    <title>Code coverage report for lib/resources/register.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/resources</a> register.js
    </h1>
    <div class='clearfix'>
    </div>
  </div>
...
&nbsp;
   ...
   * Makes a request to /register/settlement_obligations/contracts<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ></span></span>
   *
   * @param {Object} opts An options params which
   *                      is usually already bound
   *                      by `connect` functions.
...
const contracts = (opts, body) =&gt;
  request.get(opts, routes.register.settlementObligations.contracts, body)<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ></span></span>
&nbsp;
/**
...
*/
const contestations <span class="cstat-no" title="statement not covered" >= (opts, <span class="fstat-no" title="function not covered" >body) =&gt;</span></span>
 ...
 */
const createContestation <span class="cstat-no" title="statement not covered" >= (opts, <span class="fstat-no" title="function not covered" >body) =&gt;</span></span>
